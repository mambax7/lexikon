...
//                $entriesArray['offline'] = $entriesTempArray[$i]->getVar('offline');
    ...
    case 'delete':
        ...
        if (1 == Request::getInt('ok', 0)) {
            ...
            xoops_confirm(array('ok' => 1, 'entryID' => Request::getString('entryID', ''), 'op' => 'delete'), Request::getCmd('REQUEST_URI', '', 'SERVER'), sprintf(AM_LEXIKON_FORMSUREDEL, $entriesObject->getVar('term')));
        }
        break;
