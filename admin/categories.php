...
*/
    ...
    case 'delete':
        ...
        if (1 == Request::getInt('ok', 0)) {
            ...
            xoops_confirm(array('ok' => 1, 'categoryID' => Request::getString('categoryID', ''), 'op' => 'delete'), Request::getCmd('REQUEST_URI', '', 'SERVER'), sprintf(AM_LEXIKON_FORMSUREDEL, $categoriesObject->getVar('categoryID')));
        }
        break;
